          ...
          <div class="bg-(--background) text-white h-screen border-l-2 flex flex-col">
            ...
            <div class="mt-auto p-5 max-h-20">
              <form class="flex items-center gap-2">
                <input type="text" placeholder="Write a message" class="h-10 rounded-md w-full text-md bg-(--primary-hover) p-1 caret-fuchsia-300 hover:border-0" />
